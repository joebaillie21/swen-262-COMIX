...
public class SearchForGaps implements SearchStrategy{
    ...
    public static void main(String []  args){
        ...
        ComicBookComponent cb18 = new ComicBookComponent(p1, title1, "1", "14", pubdate, author, null,  "example"  );
        ComicBookComponent cb19 = new ComicBookComponent(p1, title1,"1" , "15", pubdate, author, null,  "example"  );
        ComicBookComponent cb20 = new ComicBookComponent(p1, title1,"1" , "13", pubdate, author, null,  "example"  );
